...
3. "target_focus_topics": 2-4 topics to prioritize — prefer topics that are both stale/blind-spot AND appear in the weak_topics of a company_readiness entry the candidate is closest to being ready for.
